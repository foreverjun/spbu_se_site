...
def index_staff():
    ...
    return render_template(
        "practice/staff/current_thesises_staff.html", thesises=current_thesises
    )
...
def finished_thesises_staff():
    ...
    return render_template(
        "practice/staff/finished_thesises_staff.html", thesises=current_thesises
    )
...
def thesis_staff():
    ...
    return render_template(
        "practice/staff/thesis_staff.html",
        thesis=current_thesis,
    ...
    if current_report_id:
        ...
        if request.method == "POST":
            if "submit_button" + str(current_report_id) in request.form:
                ...
                return render_template(
                    "practice/staff/reports_staff.html",
                    thesis=current_thesis,
                    reports=reports,
